        ...
        <div class="container py-5">
            ...
            <div class="row shop-wthree-info text-center">
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b1.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b2.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b3.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b4.jpg') }}" class="img-fluid" alt="">
            ...
            <div class="row shop-wthree-info text-center">
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b5.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b6.jpg') }}" class="img-fluid" alt="">
                ...
                <div class="col-lg-3 shop-info-grid text-center mt-4">
                    <div class="product-shoe-info shoe">
                        <div class="men-thumb-item">
                            <img src="{{ asset('front/images/b8.jpg') }}" class="img-fluid" alt="">
