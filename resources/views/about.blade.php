        ...
        <div class="container py-md-5">
            ...
            <div class="row text-center">
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="{{ asset('front/images/c1.jpg') }}" class="img-fluid" alt="" />
                </div>
                ...
                <div class="col-md-4 content-gd-wthree">
                    <img src="{{ asset('front/images/c2.jpg') }}" class="img-fluid" alt="" />
                </div>
            </div>
    ...
    <section class="mid-section">
        <div class="d-lg-flex p-0">
            <div class="col-lg-6 bottom-w3pvt-left p-lg-0">
                <img src="{{ asset('front/images/ab1.jpg') }}" class="img-fluid" alt="" />
            ...
            <div class="col-lg-6 bottom-w3pvt-left bottom-w3pvt-right p-lg-0">
                <img src="{{ asset('front/images/ab2.jpg') }}" class="img-fluid" alt="" />
                <div class="pos-w3pvt">
